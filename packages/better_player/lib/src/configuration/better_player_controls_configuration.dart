...
class BetterPlayerControlsConfiguration {
  ...
  const BetterPlayerControlsConfiguration({
    ...
    this.playIcon = Icons.play_circle_filled_sharp,
    this.pauseIcon = Icons.pause_circle_outline_rounded,
    ...
    this.progressBarBufferedColor = Colors.white30,
    this.progressBarBackgroundColor = Colors.white30,

    // this.progressBarPlayedColor = Colors.red,
    // this.progressBarHandleColor = Colors.yellow,
    // this.progressBarBufferedColor = Colors.blue,
    // this.progressBarBackgroundColor = Colors.green,
